export const environment = {
  ...
  SvUpdateProfileUrl: 'https://obscure-gorge-43420.herokuapp.com/api/auth/update-profile',
  SvUpdatePasswordUrl: 'https://obscure-gorge-43420.herokuapp.com/auth/update-password',
};
